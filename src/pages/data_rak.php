                ...
                <div class="d-flex justify-content-end">
                    <nav class="flex-shrink-0 mt-3 mt-sm-0 ms-sm-3" aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-alt">
                            ...
                            <li class="breadcrumb-item">
                                <a class="link-fx" href="index.php?page=buat_rak">Buat Rak</a>
                            </li>
    ...
    <div class="content">
        ...
        <div class="block block-rounded">
            <div class="block-header block-header-default">
                <h3 class="block-title"><b>Data Rak</b></h3>
                <div class="block-options">
                    <a href="index.php?page=buat_rak">
                ...
                <table
                    ...
                    class="table table-bordered table-striped table-vcenter js-dataTable-buttons dataTable">
                        ...
                        <tbody class="text-center">
                            ...
                            $sql = "SELECT rak.*, kategori.nama_kategori 
                                FROM rak 
                                LEFT JOIN kategori ON rak.kategori_id = kategori.id";
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $data['nama_rak'] ?></td>
                                    <td><?php echo $data['nama_kategori'] ?></td>
                                    <td class="text-center">
                                        <div class="btn-group">
                                            <form action="action/rak_hapus.php" method="post">
                                            ...
                                            <a href="index.php?page=buat_rak_edit&id=<?= $data['id'] ?>" type="button" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled px-3 rounded-pill bg-info-light text-info" data-bs-toggle="tooltip" aria-label="Edit" data-bs-original-title="Edit">
