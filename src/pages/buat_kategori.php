            ...
            <div class="block-content block-content-full">
                <div class="row">
                    <div class="col space-y-5">
                        <form action="action/kategori_create.php" method="POST">
                            <div class="mb-4">
                                <label class="form-label" for="">Nama Kategori</label>
                                <input type="text" class="form-control" name="namkat" required oninvalid="this.setCustomValidity('Data tidak boleh kosong')" oninput="setCustomValidity('')">
                            </div>
                            <div class="mb-4">
